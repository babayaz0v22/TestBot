package uz.test.bot.web.rest;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
import static uz.test.bot.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import uz.test.bot.IntegrationTest;
import uz.test.bot.config.Constants;
import uz.test.bot.domain.User;
import uz.test.bot.repository.AuthorityRepository;
import uz.test.bot.repository.UserRepository;
import uz.test.bot.security.AuthoritiesConstants;
import uz.test.bot.service.UserService;
import uz.test.bot.service.dto.AdminUserDTO;
import uz.test.bot.service.dto.PasswordChangeDTO;
import uz.test.bot.service.dto.UserDTO;
import uz.test.bot.web.rest.vm.KeyAndPasswordVM;
import uz.test.bot.web.rest.vm.ManagedUserVM;
